...
@section('konten')
    <section id="Postingan" class="min-vh-100 bg-admin">
        <div class="container text-white py-5">
            ...
            <form action="/open/donation" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row bg-white gap-4 align-items-center rounded">
                    <div class="col text-center bg-white text-dark">
                        <label for="foto">
                            <img id="preview" alt="" width="400" style="object-fit: contain">
                    ...
                    <div class="col bg-admin">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn w-100" style="background-color: #EAE7B1">Open Donation</button>
                        </div>
                    </div>
                </div>
            </form>
